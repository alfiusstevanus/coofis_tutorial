...
urlpatterns = [
        ...
        path("detail/<str:id>/", post_views.PostRetrieveUpdateDestroyAPIView.as_view(), name="post-detail"),
        path("update/<str:id>/", post_views.PostRetrieveUpdateDestroyAPIView.as_view(), name="post-update"),
        path("delete/<str:id>/", post_views.PostRetrieveUpdateDestroyAPIView.as_view(), name="post-delete"),
